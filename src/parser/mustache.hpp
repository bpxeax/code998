...
#ifndef __COOLMONKEY_MUSTACHE_HPP__
#define __COOLMONKEY_MUSTACHE_HPP__
...
namespace CoolMonkey {
    ...
    namespace Mustache
    {
        ...
        using Mustache = CoolMonkey::Mustache::BasicMustache<std::string>;
        using MustacheW = CoolMonkey::Mustache::BasicMustache<std::wstring>;
    }
}
